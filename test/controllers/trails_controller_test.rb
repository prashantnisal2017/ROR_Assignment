...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { patients_id: @trail.patients_id, trail_configuration_id: @trail.trail_configuration_id } }
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { patients_id: @trail.patients_id, trail_configuration_id: @trail.trail_configuration_id } }
