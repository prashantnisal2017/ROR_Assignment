...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { name: @drug.name, side_effect: @drug.side_effect, target_alignment: @drug.target_alignment } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { name: @drug.name, side_effect: @drug.side_effect, target_alignment: @drug.target_alignment } }
